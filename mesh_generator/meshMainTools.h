...
#define PI 3.14159265358979323
	...
	vector<QPointF> createVFrpr(vector<QPointF> pol, vector<bool> vBool)
	{
	...
	vector<Singular> createSingPts(vector<Triangle> mesh, vector<QPointF> total, vector<QPointF> u, vector<Triangle *> *triSing)
	{
		QPointF v0, v1, v2;
		vector<int> nodes;
		Matrix Pe(3, 3);
